...
const SelectLanguage = () => {
  ...
  return (
    ...
    >
      ...
      <section className="flex-1 flex flex-col md:flex-row justify-start md:justify-center items-start md:items-center gap-3 md:gap-6 px-4 md:px-10 py-4 md:py-6 overflow-y-auto md:overflow-y-auto min-h-0">
